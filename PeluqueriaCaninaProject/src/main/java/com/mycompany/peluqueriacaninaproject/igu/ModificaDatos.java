...
public class ModificaDatos extends javax.swing.JFrame {
    ...
    int num_cliente;
    Mascota masco;
    public ModificaDatos(int num_cliente) {
        this.num_cliente = num_cliente;
        controladoraLogica = new Controladora();
        initComponents();
        //traemos la mascota para luego setearle los datos en este método que invocamos acá
    ...
    private void initComponents() {
        ...
        btnGuardarCambios.setIcon(new javax.swing.ImageIcon("C:\\Users\\LENOVO\\matias\\proyectos\\PeluqueriaCaninaProject\\src\\main\\resources\\imagenes\\icono_guardar.png")); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btnGuardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(87, 87, 87))
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
      //Asignamos los nuevos datos de la mascota
      ...
      //Asignamos los nuevos datos del dueño
      String nombreDueno = txtNombreDueno.getText();
      String celDueno = txtCelDueno.getText();     
      
      controladoraLogica.modificarMascota(masco, nombreMascota, raza, color, observaciones, 
                                          alergico, atencionEsp, nombreDueno, celDueno);
      
        mostrarMensaje("Edición relizada correctamente", "info", "Edición de mascota");
    ...
    private void cargarDatos(int num_cliente) {
        ...
        this.masco = controladoraLogica.traerMascota(num_cliente);

       txtNombre.setText(masco.getNombre());
       txtCelDueno.setText(masco.getDueno().getCelDueno());
       txtColor.setText(masco.getColor());
       txtNombreDueno.setText(masco.getDueno().getNombre());
       txtOvservaciones.setText(masco.getObservaciones());
